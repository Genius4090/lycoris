              ...
              <div className="screen_out w-auto h-auto rounded-[10px]">
                <div className="screen_out1 w-[11em] h-[7.75em] flex items-center justify-center rounded-[10px]">
                  <div className="screen">
                    <span className="bg-black px-[0.5em] text-[0.75em] text-white tracking-normal rounded-[5px] z-10">{`${"Error :("}`}</span>
                  </div>
                  <div className="screenM">
                    <span className="bg-black px-[0.3em] text-[0.75em] text-white tracking-normal rounded-[5px] z-10">Error</span>
                  </div>
                </div>
              </div>
            </div>
