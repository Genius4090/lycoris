...
const About = () => {
  ...
  return (
    <section className="pt-50 flex flex-col items-center">
      ...
      <p className="text-textish max-w-[613px] text-center leading-6.5 mt-6">Discover beautifully crafted arrangements made with love and care. Let us help you create moments that bloom with joy and elegance.</p>
